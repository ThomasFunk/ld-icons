...
class XdgPopup(Interface):
    ...
    :class:`~pywayland.protocol.wayland.XdgToplevel`.

    The parent of an :class:`XdgPopup` must be mapped (see the
    :class:`~pywayland.protocol.wayland.XdgSurface` description) before the
...
class XdgPopupProxy(Proxy[XdgPopup]):
    ...
    def destroy(self) -> None:
        ...
        <pywayland.protocol.wayland.XdgWmBase.not_the_topmost_popup>` protocol
        error will be sent.
        """
        self._marshal(0)
        self._destroy()
    ...
    def grab(self, seat: WlSeat, serial: int) -> None:
        ...
        :class:`~pywayland.protocol.wayland.XdgToplevel` surface or another
    ...
    def reposition(self, positioner: XdgPositioner, token: int) -> None:
        ...
        :class:`~pywayland.protocol.wayland.XdgPositioner` object, and a
        :func:`XdgPopup.repositioned()` followed by
        :func:`XdgPopup.configure()` and :func:`XdgSurface.configure()
        <pywayland.protocol.wayland.XdgSurface.configure>` will be emitted in
        ...
        <pywayland.protocol.wayland.XdgPositioner.set_parent_configure>` and
        possibly an :func:`XdgPositioner.set_parent_size()
        <pywayland.protocol.wayland.XdgPositioner.set_parent_size>` request to
        allow the compositor to properly constrain the popup.

        If the popup is repositioned together with a parent that is being
        resized, but not in response to a configure event, the client should
        send an :func:`XdgPositioner.set_parent_size()
        <pywayland.protocol.wayland.XdgPositioner.set_parent_size>` request.

        :param positioner:
        :type positioner:
            :class:`~pywayland.protocol.wayland.XdgPositioner`
        :param token:
...
class XdgPopupResource(Resource):
    ...
    def configure(self, x: int, y: int, width: int, height: int) -> None:
        ...
        <pywayland.protocol.wayland.XdgSurface.configure>` for details.

        The x and y arguments represent the position the popup was placed at
        given the :class:`~pywayland.protocol.wayland.XdgPositioner` rule,
        ...
        :class:`~pywayland.protocol.wayland.XdgPositioner` with set_reactive
    ...
    def repositioned(self, token: int) -> None:
        ...
        <pywayland.protocol.wayland.XdgSurface.configure>` to notify the
        ...
        <pywayland.protocol.wayland.XdgSurface.configure>` will be sent with
        ...
        <pywayland.protocol.wayland.XdgSurface.ack_configure>` for details.
