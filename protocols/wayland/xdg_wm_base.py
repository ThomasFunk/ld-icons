...
class XdgWmBaseProxy(Proxy[XdgWmBase]):
    ...
    def create_positioner(self) -> Proxy[XdgPositioner]:
        ...
        <pywayland.protocol.wayland.XdgSurface.get_popup>` for details.
    ...
    def get_xdg_surface(self, surface: WlSurface) -> Proxy[XdgSurface]:
        ...
        This creates an :class:`~pywayland.protocol.wayland.XdgSurface` for the
        given surface. While :class:`~pywayland.protocol.wayland.XdgSurface`
        itself is not a role, the corresponding surface may only be assigned a
        role extending :class:`~pywayland.protocol.wayland.XdgSurface`, such as
        :class:`~pywayland.protocol.wayland.XdgToplevel` or
        :class:`~pywayland.protocol.wayland.XdgPopup`. It is illegal to create
        an :class:`~pywayland.protocol.wayland.XdgSurface` for a
        :class:`~pywayland.protocol.wayland.WlSurface` which already has an
        assigned role and this will result in a role error.

        This creates an :class:`~pywayland.protocol.wayland.XdgSurface` for the
        given surface. An :class:`~pywayland.protocol.wayland.XdgSurface` is
        used as basis to define a role to a given surface, such as
        :class:`~pywayland.protocol.wayland.XdgToplevel` or
        :class:`~pywayland.protocol.wayland.XdgPopup`. It also manages
        functionality shared between
        :class:`~pywayland.protocol.wayland.XdgSurface` based surface roles.

        See the documentation of
        :class:`~pywayland.protocol.wayland.XdgSurface` for more details about
        what an :class:`~pywayland.protocol.wayland.XdgSurface` is and how it
        is used.
        ...
        :returns:
            :class:`~pywayland.protocol.wayland.XdgSurface`
        """
