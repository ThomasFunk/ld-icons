...
class XdgToplevel(Interface):
    ...
    This interface defines an :class:`~pywayland.protocol.wayland.XdgSurface`
    ...
    <pywayland.protocol.wayland.XdgSurface.get_toplevel>`. The client can re-
    ...
    :class:`~pywayland.protocol.wayland.XdgSurface` description).
...
class XdgToplevelProxy(Proxy[XdgToplevel]):
    ...
    def set_max_size(self, width: int, height: int) -> None:
        ...
        <pywayland.protocol.wayland.XdgSurface.set_window_geometry>`.
...
class XdgToplevelResource(Resource):
    ...
    def configure(self, width: int, height: int, states: list) -> None:
        ...
        <pywayland.protocol.wayland.XdgSurface.configure>` and
    ...
    def configure_bounds(self, width: int, height: int) -> None:
        ...
        <pywayland.protocol.wayland.XdgSurface.configure>`.
    ...
    def wm_capabilities(self, capabilities: list) -> None:
        ...
        :func:`XdgSurface.configure()
        <pywayland.protocol.wayland.XdgSurface.configure>` event. When the
        capabilities change, compositors must send this event again and then
        send an :func:`XdgSurface.configure()
        <pywayland.protocol.wayland.XdgSurface.configure>` event.
