...
class XdgSurfaceProxy(Proxy[XdgSurface]):
    ...
    def get_toplevel(self) -> Proxy[XdgToplevel]:
        """Assign the :class:`~pywayland.protocol.wayland.XdgToplevel` surface role

        This creates an :class:`~pywayland.protocol.wayland.XdgToplevel` object
        for the given :class:`XdgSurface` and gives the associated
        :class:`~pywayland.protocol.wayland.WlSurface` the
        :class:`~pywayland.protocol.wayland.XdgToplevel` role.

        See the documentation of
        :class:`~pywayland.protocol.wayland.XdgToplevel` for more details about
        what an :class:`~pywayland.protocol.wayland.XdgToplevel` is and how it
        is used.
    ...
    def get_popup(self, parent: XdgSurface | None, positioner: XdgPositioner) -> Proxy[XdgPopup]:
        """Assign the :class:`~pywayland.protocol.wayland.XdgPopup` surface role

        This creates an :class:`~pywayland.protocol.wayland.XdgPopup` object
        for the given :class:`XdgSurface` and gives the associated
        :class:`~pywayland.protocol.wayland.WlSurface` the
        :class:`~pywayland.protocol.wayland.XdgPopup` role.

        If null is passed as a parent, a parent surface must be specified using
        some other protocol, before committing the initial state.

        See the documentation of :class:`~pywayland.protocol.wayland.XdgPopup`
        for more details about what an
        :class:`~pywayland.protocol.wayland.XdgPopup` is and how it is used.
        ...
        :returns:
            :class:`~pywayland.protocol.wayland.XdgPopup`
        """
