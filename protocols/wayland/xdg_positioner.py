...
class XdgPositionerProxy(Proxy[XdgPositioner]):
    ...
    def set_anchor_rect(self, x: int, y: int, width: int, height: int) -> None:
        ...
        <pywayland.protocol.wayland.XdgSurface.set_window_geometry>` of the
        parent surface.
    ...
    def set_reactive(self) -> None:
        ...
        <pywayland.protocol.wayland.XdgPopup.configure>` event is sent with
    ...
    def set_parent_configure(self, serial: int) -> None:
        ...
        <pywayland.protocol.wayland.XdgSurface.configure>` event this
